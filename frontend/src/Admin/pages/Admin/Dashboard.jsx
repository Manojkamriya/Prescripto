...
if (!dashData) return <div className="m-5">Loading dashboard...</div>;
  ...
  return dashData && (
    ...
    <div className='bg-white'>
     ...
     <div className='flex items-center px-6 py-2 gap-3 bg-gray-100 text-sm font-semibold text-gray-700 border-b'>
    <div className='w-48'>Doctor Info</div>
    <div className='w-48'>User Info</div>
    {/* <div className='flex-1'>Appointment Info</div> */}
    <div className='w-32 text-center'>Status / Action</div>
  </div>
        {
            ...
            <div className='flex items-center px-6 py-3 gap-3' key={index}>
              ...
              <div className='flex-1 text-sm'>
               ...
               <div className='flex-1 text-sm'>
                ...
                <p className='text-gray-600'>{item?.userData?.email}</p>
              </div>
              { 
        item.cancelled 
